<%-- 
    Document   : oreg
    Created on : Apr 26, 2017, 2:46:20 PM
    Author     : java3
--%>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
   <div class="group">
       <center><h6 class="heading">DATA OWNER REGISTRATION</h6></center><br><br>
       <div style="float: right">
      
         
<img style="width: 500px" src="images/demo/backgrounds/reg.png" alt="" />
      </div>
      <div>
        <div id="comments">                       
        <form action="oreg1.jsp" method="get" enctype="multipart/form-data">
          <div class="one_third">
