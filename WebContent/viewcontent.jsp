<%-- 
    ...
    Created on : May 3, 2017, 10:09:49 AM
    Author     : java3
--%>
...
<center><h6 class="heading">Decryption And View</h6></center><br><br><br>
<div id="comments" style="float: right;margin-right: 300px">
                               
        <form action="viewfile.jsp" method="get">
          <div>
            <label for="name"> Verify  <span>*</span></label>
            <input style="width: 250px;height: 35px;" type="text" name="decrypt" id="name" value=""  required>
          </div><br><br><br><br>
           <div>
            <input type="submit" name="submit" value="Decrypt And View">
            &nbsp;
