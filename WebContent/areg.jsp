<%-- 
    Document   : areg
    Created on : Apr 26, 2017, 2:49:51 PM
    Author     : java3
--%>
    ...
    <body id="top">
        ...
        <div class="wrapper row3">
            <main class="hoc container clear"> 
                <div class="group">
                    <center><h6 class="heading">ATTRIBUTE AUTHORITY REGISTRATION</h6></center><br><br>
                    <div style="float: right">


                        <img style="width: 500px" src="images/demo/backgrounds/aasig.jpg" alt="" />
                    </div>
                    <div>
                        <div id="comments">

                            <form action="aareg1.jsp" method="get"enctype="multipart/form-data">
                                <div class="one_third">
                                ...
                                <div class="one_third">
                                    ...
                                    <select style="width: 250px;height: 35px;" name="gen" class="form-control">
                                ...
                                <div class="one_third">
                                    ...
                                    <input style="width: 250px;height: 35px;" type="text" name="state" id="state" value="" required>
                                </div><br><br><br><br>
                                <div class="one_third" >
                                    <label for="Country">Country<span>*</span></label>
                                    <input style="width: 250px;height: 35px;" type="text" name="country" id="country" value="" required>
                                </div>
