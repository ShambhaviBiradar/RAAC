<%-- 
    Document   : cahome
    Created on : Apr 27, 2017, 7:01:47 PM
    Author     : java3
--%>
            ...
            <main class="hoc container clear"> 
                <div class="wrapper row4">
                    <footer id="footer" class="hoc clear"> 
                        ...
                        <center><h6 class="heading">Central Authority Home</h6></center>

                        <div style="float: right">
                            <ul class="nospace group">
                                <!--          <li class="one_half first btmspace-50">-->
                                <img style="width: 500px;margin-right: 100px" src="images/demo/backgrounds/cahome.jpg" alt="" />
                        </div> 
                        <div class="one_third">
