<%-- 
    Document   : aalog
    Created on : Apr 27, 2017, 6:22:43 PM
    Author     : java3
--%>
...
<html lang="">
    ...
    %>
    <script>alert('Enter Correct User Name and Password');</script>
    <%            }
    %>
    <%
        if (request.getParameter("msggg") != null) {
    %>
    <script>alert('Your are not yet Activated..');</script>
    <%            }
    %>
    <body id="top">
        <!-- ################################################################################################ -->
            ...
            <main class="hoc container clear"> 
                <div class="wrapper row4">
                    <footer id="footer" class="hoc clear"> 
                        ...
                        <center><h6 class="heading">Attribute Authority LOGIN</h6></center>
                        ...
                        <div class="one_third">
                            <form method="get" action="aalog1.jsp">
                                <fieldset>
