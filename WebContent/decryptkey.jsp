<%-- 
    Document   : decryptkey
    Created on : Apr 29, 2017, 3:26:28 PM
    Author     : java3
--%>
    ...
    <body id="top">
        ...
        <div class="wrapper row3">
            <main class="hoc container clear"> 
               <center> <h3>File Download Key Requests</h3></center>
        ...
        <table>
          <thead>
            <tr>
              ...
              <th>Send Decrypt And Download Key</th>
            </tr>
          </thead>
          <%
                                    ...
                                    try {
                                        ...
                                        rs = st.executeQuery("select * from filerequest where status='requesting' and accesspolicy='download'");
                                        while(rs.next())
