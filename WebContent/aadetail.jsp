<%-- 
    Document   : aadetail
    Created on : Apr 28, 2017, 10:17:34 AM
    Author     : java3
--%>
    ...
    <body id="top">
        ...
        <div class="wrapper row3">
            <main class="hoc container clear"> 
                <center> <h3>Auditing Attribute Authority's</h3></center><br><br><br>
                    ...
                    <table>
                        ...
                        <%
                            ...
                            try {
                                ...
                                rs = st.executeQuery("select * from aareg");
                                while (rs.next()) {%>                    
                        <tr>
                            ...
                            <td><a href="view.jsp?id=<%=rs.getString("id")%>">View</a></td>
                            <td><a href="aactivate.jsp?id=<%=rs.getString("id")%>">Activate</a></td>
                            <td><a href="aadeactivate.jsp?id=<%=rs.getString("id")%>">Delete</a></td>
                        </tr>
